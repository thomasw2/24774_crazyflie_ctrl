...
{
    motorsSetRatio(MOTOR_M1, control->m1*100);
    motorsSetRatio(MOTOR_M2, control->m2*100);
    motorsSetRatio(MOTOR_M3, control->m3*100);
    motorsSetRatio(MOTOR_M4, control->m4*100);
